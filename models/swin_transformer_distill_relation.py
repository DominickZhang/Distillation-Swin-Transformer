...
class WindowAttentionRelation(nn.Module):
...
class SwinTransformerBlockRelation(nn.Module):
    ...
    def __init__(self, dim, input_resolution, num_heads, window_size=7, shift_size=0,
        ...
        self.attn = WindowAttentionRelation(
...
class BasicLayerRelation(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
        ...
        self.blocks = nn.ModuleList([
            SwinTransformerBlockRelation(dim=dim, input_resolution=input_resolution,
...
class SwinTransformerRelation(nn.Module):
    r""" Swin Transformer
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        for i_layer in range(self.num_layers):
            layer = BasicLayerRelation(dim=int(embed_dim * 2 ** i_layer),
