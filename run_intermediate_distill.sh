...
python -m torch.distributed.launch --nproc_per_node 8 --master_port 1234  main.py --do_distill --cfg configs/swin_tiny_patch4_window7_224_distill_intermediate.yaml --data-path $data_path --teacher $teacher --batch-size 128 --tag intermediate --train_intermediate --ar 48 --student_layer_list [11] --teacher_layer_list [23] --total_train_epoch $epoch_num_interm --output $output_dir --base_lr $base_lr
